...
<p style="color:black;font-weight:bold;font-size:19px;margin-left:-65px;margin-top:-15px">Room No</p><br>
<p style="margin-left:-60px;margin-top:-15.5px">
			
				<input type='text' name='room' id="room" placeholder='Room No' style="width:20%;">	</p>			
			
<marquee behavior="scroll" direction="left" style="color:white; font-family:'Arial' font-size:35px;width:240px;"><b>eg:- Hall 2, 342 / Hall 3, 309 / Hall 4,  e-302 / Hall 5, c-310 / Hall 6, ghtb-312 / Hall 8, c-313 / Hall 9, h-301 / Hall 10, a-338 / Hall 11, c-213 / Gh, d-107 </b></marquee>
<br><br><br>
					 
 

			<p style="margin-left:-75px;margin-top:30px;">
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> 
			...
			<table>
				<tr>
					<p style='background:Blue;box-shadow:0px 0px 1px rgb(216, 216, 216);padding:10px;text-align:center;margin-top:80px;font-weight:bold;position:fixed;bottom:0px;left:0px;right:0px;' >Designed and Developed By <a href="https://www.facebook.com/rahulkumarraynauheed" target='_blank' style='text-decoration:underline;background:color:yellow;color:red'>Rahul Kumar</a></p>
				</tr>
			</table>
